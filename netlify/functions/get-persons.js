...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    try {
        ...
        // For performance, it's better to clear and bulk-insert than to do many individual updates.
        // However, ON CONFLICT is safer and simpler for this use case.
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        persons: persons.filter(p => p.can_preach) // Only return people who can preach to the frontend
      })
    };
