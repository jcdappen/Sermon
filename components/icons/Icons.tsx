...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.513-.96 1.49-1.683 2.63-1.938m-2.63 1.938c-.513.96-1.49 1.683-2.63 1.938m-2.63-1.938a9.094 9.094 0 003.741.479 3 3 0 004.682-2.72M12 12.75a4.5 4.5 0 110-9 4.5 4.5 0 010 9z" />
  </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l.354-.354a3.75 3.75 0 0 0-5.303-5.303l-.354.354M3 21l3.75-3.75m.879-1.585 5.303-5.303a3.75 3.75 0 0 1 5.303 5.303l-5.303 5.303-5.303-5.303Z" />
  </svg>
);
...
export const HomeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a.75.75 0 011.06 0l8.955 8.955M3 10.5v.75a3 3 0 003 3h1.5a3 3 0 003-3v-.75m-6 0V21a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25V10.5m-6 0h6m6 0a3 3 0 013 3v.75a3 3 0 01-3 3h-1.5a3 3 0 01-3-3v-.75m6 0V21a2.25 2.25 0 01-2.25 2.25h-1.5a2.25 2.25 0 01-2.25-2.25V10.5m6 0h-6" />
    </svg>
);
